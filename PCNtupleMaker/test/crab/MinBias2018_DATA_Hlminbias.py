...
config.General.requestName = 'DPG_HlMinBias2018_data'
...
config.Data.outLFNDirBase = '/store/user/jsingera/DPG/PC/HlMinBias2018_data'
config.Data.publication = True
config.Data.outputDatasetTag = 'DPG_HlMinBias2018_data'
