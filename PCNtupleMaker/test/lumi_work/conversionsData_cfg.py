...
#interactive run
options.inputFiles = ["file:/home/t3-ku/janguian/files/DPG_lumi_weight_testing/minbias_2018B_data/44658FF9-867F-E811-9BF8-FA163EF212C3.root"]
options.outputFile = "lumiTest.root"
...
######process.Path = cms.Path( vertexTables * testseq + lumiseq )
process.Path = cms.Path(lumiseq)
