...
process.Tk0Table = cms.EDProducer("SimpleCandidateFlatTableProducer",
    cut = cms.string(''),
...
process.c0MCTable = cms.EDProducer("CandMCMatchTableProducer",
...
process.c0TrackCandidates = cms.EDProducer("ChargedCandidateProducer",
    particleType = cms.string('e+'),
    src = cms.InputTag("c0tks","convTrks")
)


process.c0tks = cms.EDProducer("convTrkProducer",
    src = cms.InputTag("allConversions"),
    trkCandIdx = cms.int32(0)
)


process.c1tks = cms.EDProducer("convTrkProducer",
    src = cms.InputTag("allConversions"),
    trkCandIdx = cms.int32(1)
)


process.convMCMatchForTable = cms.EDProducer("MCMatcher",
...
process.convTable = cms.EDProducer("SimpleConversionTableProducer",
    ...
    externalVariables = cms.PSet(
        Tk0_Idx = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('index of nearest sim track in dR'),
            mcOnly = cms.bool(False),
            precision = cms.int32(-1),
            src = cms.InputTag("tkmatch","Tk0Idx"),
            type = cms.string('int')
        ),
        Tk0_dPtRel = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('dptrel with nearest sim track (by dr), abs(ptsim - pt)/ptsim'),
            mcOnly = cms.bool(False),
            precision = cms.int32(-1),
            src = cms.InputTag("tkmatch","Tk0dPtRel"),
            type = cms.string('float')
        ),
        Tk0_dR = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('dR with nearest sim track'),
            mcOnly = cms.bool(False),
            precision = cms.int32(-1),
            src = cms.InputTag("tkmatch","Tk0dR"),
            type = cms.string('float')
        ),
        Tk1_Idx = cms.PSet(
            compression = cms.string('none'),
            ...
            mcOnly = cms.bool(False),
            precision = cms.int32(-1),
            src = cms.InputTag("tkmatch","Tk1Idx"),
            type = cms.string('int')
        ),
        Tk1_dPtRel = cms.PSet(
            compression = cms.string('none'),
            ...
            mcOnly = cms.bool(False),
            precision = cms.int32(-1),
            src = cms.InputTag("tkmatch","Tk1dPtRel"),
            type = cms.string('float')
        ),
        Tk1_dR = cms.PSet(
            compression = cms.string('none'),
            ...
            mcOnly = cms.bool(False),
            precision = cms.int32(-1),
            src = cms.InputTag("tkmatch","Tk1dR"),
            type = cms.string('float')
        ),
        convVtxIdx = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('index of nearest sim vertex'),
            mcOnly = cms.bool(False),
            precision = cms.int32(-1),
        ...
        vtxdl = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('distance between reco conversion and nearest sim vertex'),
            mcOnly = cms.bool(False),
            precision = cms.int32(-1),
            src = cms.InputTag("vtxmatch","vtxdl"),
            type = cms.string('float')
        )
    ),
...
process.simTrackTable = cms.EDProducer("SimpleSimTrackFlatTableProducer",
    cut = cms.string(''),
    ...
    variables = cms.PSet(
        charge = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('charge of sim track'),
            expr = cms.string('charge()'),
            mcOnly = cms.bool(False),
            precision = cms.int32(-1),
            type = cms.string('float')
        ...
        eta = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('eta of sim track'),
            expr = cms.string('momentum.Eta()'),
            mcOnly = cms.bool(False),
            precision = cms.int32(8),
            type = cms.string('float')
        ),
        ...
        phi = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('phi of sim track'),
            expr = cms.string('momentum.Phi()'),
            mcOnly = cms.bool(False),
            precision = cms.int32(8),
            type = cms.string('float')
        ),
        pt = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('pt of sim track'),
            expr = cms.string('momentum.Pt()'),
            mcOnly = cms.bool(False),
            precision = cms.int32(8),
            type = cms.string('float')
        ),
        simvtx_Idx = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('index of origin sim vertex'),
            expr = cms.string('vertIndex()'),
            mcOnly = cms.bool(False),
            precision = cms.int32(-1),
            type = cms.string('int')
        ),
        trackId = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('unique integer id of sim track'),
            expr = cms.string('trackId()'),
            mcOnly = cms.bool(False),
            precision = cms.int32(-1),
            type = cms.string('int')
        )
...
process.simVertexTable = cms.EDProducer("SimpleSimVertexFlatTableProducer",
    cut = cms.string(''),
    ...
    src = cms.InputTag("g4SimHits"),
    variables = cms.PSet(
        processType = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('type of process associated with vtx'),
            expr = cms.string('processType()'),
            mcOnly = cms.bool(False),
            precision = cms.int32(-1),
            type = cms.string('int')
        ),
        simtrk_parent_tid = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('tiD of the parent sim track WARNING: NOT A VECTOR INDEX'),
            expr = cms.string('parentIndex()'),
            mcOnly = cms.bool(False),
            precision = cms.int32(-1),
            type = cms.string('int')
        ),
        tof = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('time of flight of sim vertex'),
            expr = cms.string('position.t()'),
            mcOnly = cms.bool(False),
            precision = cms.int32(8),
            type = cms.string('float')
        ),
        x = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('x position of sim vertex'),
            expr = cms.string('position.x()'),
            mcOnly = cms.bool(False),
            precision = cms.int32(8),
            type = cms.string('float')
        ...
        y = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('y position of sim vertex'),
            expr = cms.string('position.y()'),
            mcOnly = cms.bool(False),
            precision = cms.int32(8),
            type = cms.string('float')
        ...
        z = cms.PSet(
            compression = cms.string('none'),
            doc = cms.string('z postiion of sim vertex'),
            expr = cms.string('position.z()'),
            mcOnly = cms.bool(False),
            precision = cms.int32(8),
            type = cms.string('float')
...
process.tkmatch = cms.EDProducer("convTrkSimTrkMatcher",
...
process.vtxidxtable = cms.EDProducer("SimpleIntTableProducer",
    cut = cms.string(''),
    doc = cms.string('doc'),
    extension = cms.bool(False),
...
process.vtxmatch = cms.EDProducer("convVtxSimVtxMatcher",
    simsrc = cms.InputTag("g4SimHits"),
    src = cms.InputTag("allConversions")
)
...
process.simParticleTables = cms.Sequence(process.simTrackTable+process.simVertexTable)


process.convTables = cms.Sequence(process.vtxmatch+process.tkmatch+process.convTable)
...
process.Path = cms.Path(process.simParticleTables+process.vertexTables+process.convTables)
