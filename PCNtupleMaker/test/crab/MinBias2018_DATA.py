...
config.General.requestName = 'DPG_MinBias2018_data'
...
config.Data.inputDataset = '/L1MinimumBias/Run2018B-PromptReco-v2/AOD'
...
config.Data.outLFNDirBase = '/store/user/jsingera/DPG/PC/MinBias2018_data'
config.Data.publication = True
config.Data.outputDatasetTag = 'DPG_MinBias2018_data'
